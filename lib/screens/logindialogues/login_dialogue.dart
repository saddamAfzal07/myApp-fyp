...
class LoginAccountdialogue extends StatefulWidget {
  String title;
  String message;
  String initialSetup;
  LoginAccountdialogue({
    Key? key,
    required this.title,
  ...
  @override
  State<LoginAccountdialogue> createState() => _LoginAccountdialogueState();
}

class _LoginAccountdialogueState extends State<LoginAccountdialogue> {
  bool loading = false;
